...
screen info_panel():
    $ tw_gen =tw.name['Genitive']
    frame:
        padding (10,10)
        vbox:
            text "Население " + "[tw_gen]" xalign 0.5
            text "Женщин [tw.hum_pop_fem]"
            text "Мужчин [tw.hum_pop_male]"
            text "Эльфиек [tw.elf_pop_fem]"
            text "Эльфов [tw.elf_pop_male]"
            text "Кошек [tw.cat_pop_fem]"
            text "Котов [tw.cat_pop_male]"
            text "Демониц [tw.dem_pop_fem]"
            text "Демонов [tw.dem_pop_male]"
            text "Коровок [tw.cow_pop_fem]"
            text "Бычков [tw.cow_pop_male]"
