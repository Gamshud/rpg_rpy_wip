...
define config.name = _("PublicGit")
...
define gui.about = _p("""
        Публичный пробный проект для демонстрации некоторых особенностей и фишек ренпая
""")
...
define config.save_directory = "PG"
